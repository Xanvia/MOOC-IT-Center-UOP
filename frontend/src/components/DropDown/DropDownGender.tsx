...
const DropDownGender = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <span className="text-sm font-semibold text-primary pr-52">Gender</span>
      <button
        type="button"
        ...
        >
          ...
          >
            <div className="flex items-center text-primary justify-center">
              <span className="font-normal  ml-3 block truncate ">Male</span>
            </div>
          </li>
          <li
            className="text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9"
          ...
          >
            <div className="flex items-center justify-center">
              <span className="font-normal ml-3 block truncate">Female</span>
            </div>
          </li>
          <li
            className="text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9"
          ...
          >
            <div className="flex items-center justify-center">
              <span className="font-normal ml-3 block truncate">Other</span>
            </div>
          </li>
        </ul>
      )}
