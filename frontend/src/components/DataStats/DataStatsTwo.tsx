...
const DataStatsTwo = ({ id }: { id: string }) => {
        ...
        {dataStatsList.map((item, index) => (
          ...
          >
            ...
            <div className="w-full flex ">
              <div
                className="flex h-14.5 w-14 items-center justify-center rounded-full"
            ...
            <div className="mt-6 flex items-end justify-between">
              <div>
                <h4 className="mb-1.5 text-heading-6 font-bold text-dark">
                  {/* value field */}
                  {index === 0
                    ? data.data.courses.enrollments_count
                    : index === 1
                    ? data.data.courses.teachers_count
                    : data.data.courses.completed_students_count}
                </h4>
